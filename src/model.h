...
//////////////////////////////////////////////////////////////////////////////////////
//  Discrete Treatment XBCF with a mixture of trees that only depend on pi(X)
//  and trees that depend on X
//////////////////////////////////////////////////////////////////////////////////////

class XBCFDiscretePropensityShrinkageModel : public Model
{
public:
    size_t dim_suffstat = 4;
    ...
    XBCFDiscretePropensityShrinkageModel() : Model(1, 4) {}
    
    Model *clone() { return new XBCFDiscretePropensityShrinkageModel(*this); }
