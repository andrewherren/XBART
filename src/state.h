...
class XBCFDiscreteProjectedResidualState : public State
{
public:
    XBCFDiscreteProjectedResidualState(
        ...
        size_t n_min, size_t n_cutpoints, size_t mtry_con, size_t mtry_mod, 
        ...
        size_t N_trt, size_t N_ctrl
            ...
            Xpointer_con, num_sweeps, sample_weights, y_std, sigma, max_depth, 
